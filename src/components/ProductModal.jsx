...
function ProductModal({ modalMode, tempProduct, isOpen, setModalOpen, getProduct }) {
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="mb-5" >
                                    ...
                                    <input
                                        ...
                                        id="fileInput" onChange={(e) => handleFileChange(e)}
                                    />
                                </div>
                                ...
                                <div className="border border-2 border-dashed rounded-3 p-3">
                                    ...
                                    <div className="btn-group w-100">
                                        {modalData.imagesUrl.length < 5 && modalData.imagesUrl[modalData.imagesUrl.length - 1] !== '' && (<button className="btn btn-outline-primary btn-sm w-100" onClick={handleAddImage}>新增圖片</button>)}

                                        {modalData.imagesUrl.length > 1 && (<button className="btn btn-outline-danger btn-sm w-100" onClick={handleRemoveImage}>取消圖片</button>)}
